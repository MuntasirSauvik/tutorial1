...
class ViewWikiTests(unittest.TestCase):
    ...
    def _callFUT(self, request):
        from tutorial1.views.pages import view_wiki
...
class ViewPageTests(BaseTest):
    def _callFUT(self, request):
        from tutorial1.views.pages import view_page
...
class AddPageTests(BaseTest):
    def _callFUT(self, request):
        from tutorial1.views.pages import add_page
...
class EditPageTests(BaseTest):
    def _callFUT(self, request):
        from tutorial1.views.pages import edit_page
